...
The first steps that came with this project was translating the written list of conditions to binary values indicating positive and negative symptoms, this will allow for easier training. The initial ML model considered was Multinpomial Naive Bayes (MNB), this was due to the adjusted dataset satisfying the assumptions for MNB which were, Binomial characteristics, Conditional Independence, and Class Labels (Categorical Diagnosese). 
